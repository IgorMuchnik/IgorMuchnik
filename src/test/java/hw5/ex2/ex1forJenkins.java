...
@Feature("End to end test on the index page")
@Listeners({AllureScreenshotListener.class})
public class ex1forJenkins extends BaseTest {
  ...
  @Story("Log in on index page and verify web elements")
  @Test
  public void loginTest() {
    ...
    indexPageSteps.leftSectionShouldBe(Arrays.asList("Home-TEST", "Contact form", "Service",
      "Metals & Colors", "Elements packs"));     // intentional fail for test
  }
}
